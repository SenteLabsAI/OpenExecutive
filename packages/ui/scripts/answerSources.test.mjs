...
test("only web pages and in-app pages become links", () => {
  ...
  for (const bad of [null, "", "javascript:alert(1)", "data:text/html,x", "//evil.example", "/\\evil.example", "/a/../b", "ftp://x.example/f", "not a url"]) {
