...
const FOUNDER = person(1, "team", true);
...
const ROSTER = [FOUNDER, TEAMMATE, CLIENT, LEGACY];
...
test("the Team tab is just the founder in solo mode", () => {
...
test("adding a teammate in solo offers team mode; a contact or the founder does not", () => {
